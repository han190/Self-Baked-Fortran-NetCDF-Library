module module_data_structure
  ...
  interface size
    module procedure :: size_list, size_dictionary
  end interface size

  interface append
    module procedure :: append_list, append_dictionary
  end interface append

  interface scan
    module procedure :: scan_list, scan_dictionary
  end interface scan
