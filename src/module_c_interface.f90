...
!> Automatically generated by module_c_interface.py
use :: iso_c_binding
use :: iso_fortran_env
implicit none
public
...
integer(c_int), parameter :: nc_format_nc3 = nc_formatx_nc3
integer(c_int), parameter :: nc_format_nc_hdf5 = nc_formatx_nc_hdf5
integer(c_int), parameter :: nc_format_nc4 = nc_formatx_nc4
integer(c_int), parameter :: nc_format_nc_hdf4 = nc_formatx_nc_hdf4
integer(c_int), parameter :: nc_format_pnetcdf = nc_formatx_pnetcdf
integer(c_int), parameter :: nc_format_dap2 = nc_formatx_dap2
integer(c_int), parameter :: nc_format_dap4 = nc_formatx_dap4
integer(c_int), parameter :: nc_format_undefined = nc_formatx_undefined
...
interface
  ...
  function nc_def_user_format(mode_flag, dispatch_table, magic_number) &
    ...
    import NC_Dispatch, c_char, c_int
    implicit none
  ...
  function nc_def_compound(ncid, size, name, typeidp) &
    ...
    import c_char, c_int, c_size_t, nc_type
    implicit none
  ...
  function nc_put_att(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_int, c_ptr, c_size_t, nc_type
    implicit none
  ...
  function nc_insert_enum(ncid, xtype, name, value) &
    ...
    import c_char, c_int, c_ptr, nc_type
    implicit none
  ...
  function nc_inq_enum_ident(ncid, xtype, value, identifier) &
    ...
    import c_char, c_int, c_long_long, nc_type
    implicit none
  ...
  function nc_put_vars(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptr, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_att_uchar(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_int, c_signed_char, c_size_t, nc_type
    implicit none
  ...
  function nc_get_att_uchar(ncid, varid, name, ip) &
    ...
    import c_char, c_int, c_signed_char
    implicit none
  ...
  function nc_put_att_short(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_int, c_short, c_size_t, nc_type
    implicit none
  ...
  function nc_put_att_long(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_int, c_long, c_size_t, nc_type
    implicit none
  ...
  function nc_put_att_float(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_float, c_int, c_size_t, nc_type
    implicit none
  ...
  function nc_put_att_double(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_double, c_int, c_size_t, nc_type
    implicit none
  ...
  function nc_put_att_longlong(ncid, varid, name, xtype, len, op) &
    ...
    import c_char, c_int, c_long_long, c_size_t, nc_type
    implicit none
  ...
  function nc_put_var1_longlong(ncid, varid, indexp, op) &
    ...
    import c_int, c_long_long, c_size_t
    implicit none
  ...
  function nc_put_vars_text(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_char, c_int, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_uchar(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptrdiff_t, c_signed_char, c_size_t
    implicit none
  ...
  function nc_put_vars_short(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptrdiff_t, c_short, c_size_t
    implicit none
  ...
  function nc_put_vars_long(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_long, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_float(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_float, c_int, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_double(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_double, c_int, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_longlong(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_long_long, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_free_string(nelems, data) &
  ...
  function nc_free_vlens(nelems, vlens) &
  ...
  function nc_reclaim_data(ncid, xtypeid, memory, nelems) &
    & bind(c, name="nc_reclaim_data")
    import c_int, c_ptr, c_size_t, nc_type
    implicit none
  ...
  function nc_reclaim_data_all(ncid, xtypeid, memory, nelems) &
