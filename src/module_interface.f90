...
interface
  ...
  function nc_def_user_format(mode_flag, dispatch_table, magic_number) &
    ...
    import c_int, c_char, NC_Dispatch
    implicit none
  ...
  function nc_def_compound(ncid, size, name, typeidp) &
    ...
    import c_int, c_char, nc_type, c_size_t
    implicit none
  ...
  function nc_free_vlens(len, vlens) &
    ...
    import c_int, nc_vlen_t, c_size_t
    implicit none
  ...
  function nc_put_att(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_char, nc_type, c_size_t, c_ptr
    implicit none
  ...
  function nc_insert_enum(ncid, xtype, name, value) &
    ...
    import c_int, c_char, nc_type, c_ptr
    implicit none
  ...
  function nc_inq_enum_ident(ncid, xtype, value, identifier) &
    ...
    import c_int, c_char, nc_type, c_long_long
    implicit none
  ...
  function nc_put_vars(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptrdiff_t, c_ptr, c_size_t
    implicit none
  ...
  function nc_put_att_uchar(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_char, c_signed_char, nc_type, c_size_t
    implicit none
  ...
  function nc_put_att_short(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_short, c_char, nc_type, c_size_t
    implicit none
  ...
  function nc_put_att_long(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_long, c_char, nc_type, c_size_t
    implicit none
  ...
  function nc_put_att_float(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_char, c_float, nc_type, c_size_t
    implicit none
  ...
  function nc_put_att_double(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_char, c_double, nc_type, c_size_t
    implicit none
  ...
  function nc_put_att_longlong(ncid, varid, name, xtype, len, op) &
    ...
    import c_int, c_char, nc_type, c_long_long, c_size_t
    implicit none
  ...
  function nc_put_vars_text(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_char, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_uchar(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_signed_char, c_ptrdiff_t, c_size_t
    implicit none
  ...
  function nc_put_vars_long(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptrdiff_t, c_long, c_size_t
    implicit none
  ...
  function nc_put_vars_longlong(ncid, varid, startp, countp, stridep, op) &
    ...
    import c_int, c_ptrdiff_t, c_long_long, c_size_t
    implicit none
  ...
  function nc_reclaim_data(ncid, xtypeid, memory, count) &
    ...
    import c_int, nc_type, c_ptr, c_size_t
    implicit none
